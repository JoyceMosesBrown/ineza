    ...
    rw: [
      {
        ...
        steps: [
          { icon: '🌬️', title: 'Guhuma gato', detail: 'Humeka mu maso amagana 4, hahiriza amagana 4, sohora amagana 6. Subiramo inshuro 3. Ibyo biganisha ubwonko bwawe gukora neza.' },
          { icon: '💧', title: 'Unywe amazi', detail: 'Nywa glasi imwe y\'amazi none none. Inzara n\'ubunaniro bitura mu mubiri udafite amazi ahagije.' },
          { icon: '🤲', title: 'Shyira intoki ku gituza', detail: 'Shyira intoki ku gituza. Wumve umutima wawe. Ubwo bwirabura buzana amahoro.' },
          { icon: '📞', title: 'Vugana n\'umuntu', detail: 'Hamagara umujyanama wawe cyangwa umuryango. Ntuvuge gusa ko uri meza — bwira ukuri.' },
        ],
      },
      {
        ...
        steps: [
          { icon: '🛏️', title: 'Ryama gato', detail: 'Niba mwana araryamye, ryama nawe none none — ndetse n\'iminota 15. Ubunaniro bwiyongera bikagorana.' },
          { icon: '🍌', title: 'Rya ikintu gito', detail: 'Kurya ikintu gito — umwibo, igitoki, n\'indi mfungurwa yoroheje — bifasha ubwonko kugira ingufu.' },
          { icon: '🚶', title: 'Genda inzira ngufi', detail: 'Sohoka hanze iminota 5 gusa. Urumuri rw\'izuba rw\'izuba n\'umwuka biganisha gutura imitima.' },
          { icon: '✍️', title: 'Andika icyo wumva', detail: 'Andika ijambo rimwe cyangwa ibiri ku mpapuro. Gukora ibyo bifasha ubwonko gusohora ibyiyumvo.' },
        ],
      },
    ],
    en: [
      {
        message: "I hear you, and I want you to know — what you're feeling is real and completely valid. Feeling unwell does not make you a bad mother. It means your body and mind need care right now. You reached out, and that took courage.",
        steps: [
          { icon: '🌬️', title: 'Try box breathing', detail: 'Breathe in for 4 counts, hold for 4, breathe out for 6. Repeat 3 times. This calms your nervous system quickly.' },
          { icon: '💧', title: 'Drink a glass of water', detail: 'Right now, drink one full glass of water. Dehydration makes exhaustion and anxiety feel much worse.' },
          { icon: '🤲', title: 'Place a hand on your chest', detail: 'Put your hand over your heart. Feel it beating. Breathe slowly. This simple act tells your brain you are safe.' },
          { icon: '📞', title: 'Tell someone how you feel', detail: "Text or call your CHW or someone you trust. You don't have to say much — even 'I'm struggling today' is enough." },
        ],
      },
      {
        message: "Feeling unwell is your body asking for rest and care — not a sign of weakness. You are doing something hard every single day. These small steps below can help you feel a little better right now.",
        steps: [
          { icon: '🛏️', title: 'Rest when baby rests', detail: 'If your baby is asleep, lie down — even for 15 minutes. Sleep deprivation makes everything feel harder.' },
          { icon: '🍌', title: 'Eat something small', detail: 'A banana, bread, or any small snack gives your brain the fuel it needs to regulate your emotions.' },
          { icon: '🚶', title: 'Step outside briefly', detail: 'Walk outside for just 5 minutes. Sunlight and fresh air have a measurable effect on your mood.' },
          { icon: '✍️', title: 'Write one feeling down', detail: 'Write just one word or sentence about what you feel. Getting it out of your head helps reduce its weight.' },
        ],
      },
    ],
  },
    ...
    rw: [
      {
        ...
        steps: [
          { icon: '🌿', title: 'Ibuka intsinzi zawe', detail: 'Tekereza ikintu kimwe neza wakoreye uyu munsi — ndetse n\'ikintu gito nka kuvura mwana, kurya, cyangwa gusoma iki.' },
          { icon: '💧', title: 'Unywe amazi', detail: 'Amazi afasha umubiri wawe kugira ingufu no gutuza ubwonko.' },
          { icon: '🌬️', title: 'Guhuma gato', detail: 'Humeka burambe inshuro 5. Ibyo bifasha umubiri wawe kuguma mu mahoro.' },
          { icon: '💛', title: 'Ikunda rimwe', detail: 'Jya mu maso y\'icyerekezo. Bwira ubwoko bwawe: "Ndakora neza. Ndi intwari."' },
        ],
      },
    ],
    en: [
      {
        ...
        steps: [
          { icon: '🌿', title: 'Acknowledge one win', detail: "Think of one thing you did well today — even something small like feeding your baby, eating, or reading this. That counts." },
          { icon: '💧', title: 'Stay hydrated', detail: 'Drink water throughout the day. It keeps your energy stable and helps your brain regulate mood.' },
          { icon: '🌬️', title: 'Breathe intentionally', detail: 'Take 5 slow, deep breaths whenever you feel tension rising. It resets your nervous system.' },
          { icon: '💛', title: 'Say one kind thing to yourself', detail: 'Look in the mirror or just say quietly: "I am doing enough. I am a good mother."' },
        ],
      },
    ],
  },
    ...
    rw: [
      {
        ...
        steps: [
          { icon: '📖', title: 'Andika ibimenyetso by\'umunsi mwiza', detail: 'Andika ikintu kimwe cyakugiriye akamaro uyu munsi. Ibi bifasha ubwonko bwawe gusubira ku bihe byiza.' },
          { icon: '👶', title: 'Tangira iminota y\'isano', detail: 'Gira iminota 10 y\'isano na mwana wawe — usekerane, umwite, cyangwa umwiririre.' },
          { icon: '🚶', title: 'Genda hanze', detail: 'Niba bishoboka, genda inzira ngufi. Ubwenge bwiza bujya hamwe n\'umubiri uzima.' },
          { icon: '🙏', title: 'Kubaha uyu munsi', detail: 'Umunsi mwiza si wa buri gihe — ubwike neza kandi wishime.' },
        ],
      },
    ],
    en: [
      {
        message: "So glad you're feeling well today! Your progress is real and it is showing. Hold onto this feeling — and use it to build a little more strength for the days ahead.",
        steps: [
          { icon: '📖', title: 'Journal your good moments', detail: "Write down what made today feel okay. On harder days, you can read this back as a reminder that good days exist." },
          { icon: '👶', title: 'Spend bonding time', detail: 'Use this energy for 10 minutes of connection with your baby — play, sing, or just sit together peacefully.' },
          { icon: '🚶', title: 'Go for a short walk', detail: 'If you can, step outside. Good mental health and physical movement reinforce each other.' },
          { icon: '🙏', title: 'Appreciate this day', detail: 'Good days are not always guaranteed. Be grateful for this one — you earned it.' },
        ],
      },
    ],
  },
